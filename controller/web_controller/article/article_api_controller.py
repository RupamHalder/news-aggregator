...
from service.api.news_api_service import get_news_sources_service, get_articles_service
from utils.utility import get_response
from validation.api.news_api_validation import get_articles_field_validation, \
...
def get_sources():
    try:
        field_validation, status_code = get_news_sources_field_validation(request)
